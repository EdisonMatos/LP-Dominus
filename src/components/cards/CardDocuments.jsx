export default function DocumentButtonFeatureCard(props) {
  ...
  return (
    <div
      className={`max-w-[370px] desktop1:max-w-[450px] justify-between flex flex-col tablet2:flex-row tablet2:gap-3 items-center desktop1:hover:scale-110 transition desktop1:py-2 bg-gray-200 p-4 rounded-lg shadow-md ${className}`}
    >
      ...
      <button
        ...
        className="mt-2 px-4 py-2 w-full tablet2:w-auto bg-primary text-black rounded-md desktop1:hover:scale-110 transition"
      >
        Baixar
      </button>
      {children}
