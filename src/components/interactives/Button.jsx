    ...
    >
      {animation ? (
        ...
        <div className="w-auto">
          <button
            onClick={onClick}
            className={`flex ${className} ${sizeFeatures} shadow-custom-opacityButton shadow-shadowHero/20 bg-primary flex-row items-center justify-around transition ${color} text-black desktop1:hover:scale-110`}
          >
            <div
              className={`flex items-center text-center ${gap} min-h-[24px]`}
            >
