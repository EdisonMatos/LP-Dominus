    ...
    >
      <div className="relative z-10 flex w-full bg-black bg-opacity-0 items-left">
        <div className="w-full text-secondary justify-evenly">
          ...
          <div className="flex flex-col-reverse gap-[40px] desktop1:flex-row desktop1:justify-between  mx-auto max-w-[1000px] items-center pb-[64px] pt-[40px] desktop1:pt-[68px] desktop1:pb-[96px]">
